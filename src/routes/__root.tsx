  ...
  head: () => ({
    meta: [
      ...
      { title: "Omni Target | Pre-Spend Intelligence for Shopify Merchants" },
      {
        name: "description",
        content:
          "Pre-Spend Intelligence for Shopify Merchants. Stop guessing what converts on Meta. Omni Target turns your real Shopify store data into an agency-grade Meta Ads brief in three minutes.",
      },
...
function RootShell({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-MTXLCEKC54" />
        <script
          dangerouslySetInnerHTML={{
            __html: `window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-MTXLCEKC54');`,
          }}
        />
        <HeadContent />
      </head>
