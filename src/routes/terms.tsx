  ...
  return (
    <div className="lumen min-h-screen selection:bg-primary/30 selection:text-primary-foreground">
      ...
      <main className="relative mx-auto max-w-4xl px-4 py-32 sm:px-6 sm:py-40">
        ...
        <h1 className="mb-4 font-serif text-3xl text-[var(--lx-ink)] sm:text-5xl">Terms of Service</h1>
        <p className="mb-12 font-mono text-sm text-[var(--lx-ink-faint)]">Last updated: May 26, 2026</p>
        ...
        <div className="prose break-words prose-p:text-[var(--lx-ink-soft)] prose-headings:text-[var(--lx-ink)] prose-a:text-[var(--lx-accent)] max-w-none space-y-8 font-sans leading-relaxed">
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">2. Description of Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">3. Account Registration</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">4. Use of AI Features and Content</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">5. User Data and Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">6. Fees and Payments</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">7. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">8. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">9. Indemnification</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">10. Modifications to the Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[var(--lx-ink)]">11. Term and Termination</h2>
            <p>
