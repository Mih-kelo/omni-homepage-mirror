...
export const COPY = {
  ...
  pricing: {
    ...
    plans: [
      {
        ...
        desc: "See what new customers buy before spending a dollar on ads.",
        features: [
          "1 complete Meta ad brief",
          "Find your #1 winning product",
          "3 scroll-stopping video hooks",
          "Step-by-step Meta setup guide",
          "Exact Meta campaign settings",
        ],
      ...
      },
      {
        ...
        price: "$9",
        usdPrice: 9,
        period: "one-time · $3 / brief",
        desc: "Ideal for testing your top 3 candidate products against cold traffic.",
        features: [
          "3 complete Meta ad briefs",
          "Find 3 winning products to test",
          "3 custom video hooks per product",
          "Audience & budget recommendations",
      ...
      },
      {
        ...
        price: "$25",
        usdPrice: 25,
        period: "one-time · $2.50 / brief",
        desc: "Our most popular pack for new collection drops and seasonal launches.",
        features: [
          "10 complete Meta ad briefs",
          "Perfect for seasonal drops & tests",
          "Save 17% vs Starter Pack",
          "Full audience & budget settings",
          "Credits never expire",
        ],
        cta: "Get Growth Pack",
        featured: true,
      },
      {
        ...
        price: "$59",
        usdPrice: 59,
        period: "one-time · $1.97 / brief",
        desc: "Maximum value for agencies and stores with expansive catalogs.",
        features: [
          "30 complete Meta ad briefs",
          "Cover your entire store catalog",
          "Save 34% (best value per brief)",
    ...
    note: "1 credit = 1 complete Meta ad brief. Buy once, use anytime. Your credits never expire and nothing bills automatically.",
    billing: "Billed safely through your official Shopify store account. Credits never expire.",
  },
